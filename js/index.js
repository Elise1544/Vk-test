...
const addEmoji = () => {
  ...
  window.emojiItems = document.querySelectorAll(`.img-emoji`);
  emojiItems.forEach(emoji => {
    window.recentlyEmoji = [];

    const showRecentlyEmojies = () => {
...
let size = 36;
function changeSize() {
  inputArea.style.cssText = 'height:' + inputArea.scrollHeight + 'px';
};
